...
\begin{document}
\title{Adapting Bayseian Filters for use of Anglular Data}
...
\subsection{Speed}
The Kalman filters rivaled the Leaky filter in speed. For instance, the average time for the Leaky filter to run was about $3$ or $4$ miliseconds, while the Kalman filters ran in about $3$ to $5$ miliseconds on about 1 second worth of data. The Particle filter took about $125$ miliseconds on that dataset, so in total about $30$ times longer than the Kalman filters.
