...
We had success filtering across both simulated and real microphone angle data; see Figure \ref{fig:all_filters} for each simulation. Using Algorithm \ref{alg:kalman} allowed us to use Kalman Filters with circular mechanics.
